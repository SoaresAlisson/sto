testthat::test_that("s2v function works correctly", {
  ...
  testthat::expect_equal(
    s2v("apple banana\ncherry\tdate\relderberry\n\rfig;apple"),
    c("apple", "banana", "cherry", "date", "elderberry", "fig", "apple")
  )
  testthat::expect_equal(
...
testthat::test_that("s2v keep_wss", {
  # Verify the output is suitable for direct R code use
  testthat::expect_equal(s2v("x y_z", keep_wss = FALSE), c("x", "y z"))
  testthat::expect_equal(s2v("x y_z", keep_wss = TRUE), c("x", "y_z"))
})
